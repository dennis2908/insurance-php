...
<div align="center">
  <table width="918" border="0" class="main_table">
    ...
    <tr>
      <td width="758"><form id="form1" name="form1" method="post" action="proses_news.php">
          <table width="360" border="0" align="center">
            <tr>
              <td height="18" class="header_style"><div align="center" class="header_style">News </div></td>
            </tr>
            <tr>
              <td><table width="350" border="0" align="center">
                  <tr>
                    <td width="119" class="writing"><div align="left">News Title : </div></td>
                    <td width="221"><label>
                        <div align="left">
                          <input name="nama_berita" type="text" class="text_area" id="nama_berita" />
                        </div>
                    </label></td>
                  </tr>
                  <tr>
			...
			?>
                  ...
                  <tr>
                    <td class="writing"> <div align="left">Content : </div></td><td><label>
                        <div align="left">
                          <label>
                          <textarea name="content" class="text_area" id="content"></textarea>
                          </label>
                        </div>
                      </label></td>
                  </tr>
